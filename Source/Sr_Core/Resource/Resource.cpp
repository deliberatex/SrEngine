...
namespace SrEngine
{
	...
	void RsrcManager::Initialize()
	{
		...
		// textures
		AddTex2D("box1", LoadTex2D(PathHelper::GetAbsolutePath("Resource/Textures/box1.png")));
		...
		facepaths.push_back(PathHelper::GetAbsolutePath("Resource/Textures/skybox/right.png"));
		facepaths.push_back(PathHelper::GetAbsolutePath("Resource/Textures/skybox/left.png"));
		facepaths.push_back(PathHelper::GetAbsolutePath("Resource/Textures/skybox/top.png"));
		facepaths.push_back(PathHelper::GetAbsolutePath("Resource/Textures/skybox/bottom.png"));
		facepaths.push_back(PathHelper::GetAbsolutePath("Resource/Textures/skybox/back.png"));
		facepaths.push_back(PathHelper::GetAbsolutePath("Resource/Textures/skybox/front.png"));
	...
	const GLuint RsrcManager::LoadTex2D(std::string filename)
	{
		...
		GLCALL(glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, w, h, 0, GL_RGBA, GL_UNSIGNED_BYTE, buffer));
	...
	void RsrcManager::CreateProgram(std::string name, std::string vtxFile, std::string fragFile)
	{
		...
		const GLuint vertexShader = ComplieShaderSource(GL_VERTEX_SHADER, LoadShaderSource(PathHelper::GetAbsolutePath(SHADERS_PATH) + vtxFile).c_str());
		const GLuint fragmentShader = ComplieShaderSource(GL_FRAGMENT_SHADER, LoadShaderSource(PathHelper::GetAbsolutePath(SHADERS_PATH) + fragFile).c_str());
